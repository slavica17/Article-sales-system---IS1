...
@NamedQueries({
    ...
    @NamedQuery(name = "Kategorija.findByNadkategorijaId", query = "SELECT k FROM Kategorija k WHERE k.nadkategorijaId = :nadkategorijaId")})
public class Kategorija implements Serializable {
    ...
    public void setNadkategorijaId(Integer nadkategorijaId) {
